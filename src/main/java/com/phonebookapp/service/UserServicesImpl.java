...
public class UserServicesImpl implements UserServices{
    ...
    public void findByPhoneNumber() throws IOException {
        System.out.print("Enter PhoneNumber: ");
        String phoneNumber = scObj.nextLine();
        PhoneBook obj = pd.findByPhoneNumber(phoneNumber);
        System.out.println(obj);
    }
    ...
    public void driverCode() throws IOException {
        boolean flag = true;
        while(flag){
            System.out.println("----------User Phonebook-----------");
            ...
            System.out.println("Enter 4 to Find entry by Id");
            System.out.println("Enter 5 to Find entry by Name");
            System.out.println("Enter 6 to Find entry by Number");
            System.out.println("Enter 7 to Find entry by DOB");
